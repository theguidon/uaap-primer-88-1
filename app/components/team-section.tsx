  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className={`text-white hidden font-display font-bold text-5xl absolute w-min ${alignment == "right" ? "text-right" : "text-left"} top-8 ${alignment == "right" ? "right-0" : "left-0"} px-8 md:block md:px-[calc(60dvw-2.5rem)] lg:top-15 xl:top-10 xl:px-[calc(60dvw-6rem)] 2xl:top-14`}
      >
        {team.split(" ").length > 2 ? (
          <>
