    ...
    >
      ...
      >
        ...
        <motion.img
          ...
          src={baseurl + `assets/images/${teamKey}.webp`}
          alt=""
          className={`absolute bottom-0 left-1/2 ${alignment == "left" ? "lg:left-2/3" : "lg:left-1/3"} -translate-x-1/2 object-cover h-[95%] z-10 ${slug == "mens-beach-volleyball" && "md:bottom-[-50px]"}`}
        />
      </motion.div>
      <div
